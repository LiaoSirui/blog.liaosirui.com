...
```bash
npm config set disturl" https://nexus.alpha-quant.com.cn/repository/nodejs-release/"
```

- node-sass: <https://github.com/sass/node-sass/releases/download/>

```bash
npm config set sass_binary_site "https://nexus.alpha-quant.com.cn/repository/github-mirror/sass/node-sass/releases/download/"
```

- electron: <https://github.com/electron/electron/releases/download/>

```bash
npm config set electron_mirror "https://nexus.alpha-quant.com.cn/repository/github-mirror/electron/electron/releases/download/"
```

- PhantomJS: <https://bitbucket.org/ariya/phantomjs/downloads/>

```bash
npm config set phantomjs_cdnurl "https://nexus.alpha-quant.com.cn/repository/bitbucket-proxy/ariya/phantomjs/downloads/"
```

- ChromeDriver: <https://chromedriver.storage.googleapis.com/>

```bash
npm config set chromedriver_cdnurl "https://nexus.alpha-quant.com.cn/repository/chromedriver/"
```

- OperaDriver: <https://github.com/operasoftware/operachromiumdriver/releases/download/>

```bash
npm config set operadriver_cdnurl "https://nexus.alpha-quant.com.cn/repository/github-mirror/operasoftware/operachromiumdriver/releases/download/" 
```

- python: <https://www.python.org/ftp/python/>

```bash
npm config set python_mirror "https://nexus.alpha-quant.com.cn/repository/python-mirror/ftp/python/" 
```

- sqlite3: <https://github.com/TryGhost/node-sqlite3/releases>

```bash
npm config set sqlite3_binary_host_mirror "https://nexus.alpha-quant.com.cn/repository/github-mirror/TryGhost/node-sqlite3/releases/download/"
```

- node-inspector: <https://node-inspector.s3.amazonaws.com/>

```bash
npm config set profiler_binary_host_mirror "https://nexus.alpha-quant.com.cn/repository/node-inspector/"
npm config set node_inspector_cdnurl "https://nexus.alpha-quant.com.cn/repository/node-inspector/"
```
...
```bash
npm config set selenium_cdnurl "https://nexus.alpha-quant.com.cn/repository/selenium/"
```



参考：<https://github.com/cnpm/cnpmcore/blob/master/config/binaries.ts>
