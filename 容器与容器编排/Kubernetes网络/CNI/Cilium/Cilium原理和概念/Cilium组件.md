...
源码位置：<https://github.com/cilium/cilium/tree/v1.18.4/plugins/cilium-cni>
...
源码位置：<https://github.com/cilium/cilium/tree/v1.18.4/daemon>
...
<img src="./.assets/Cilium组件/image-20251211130441519.png" alt="image-20251211130441519" style="zoom:67%;" />

Hubble 由以下几个部分组成

- Hubble Server ：内嵌于 Cilium Agent 中，直接从 eBPF 收集网路流量数据，并提供 gRPC API 供查询。
- Hubble Relay ：一个独立的组件，它会自动发现 Cluster 中所有的 Hubble Server，并提供一个单一的、Cluster 范围的 API 端点
- Hubble UI ：一个强大的 Web 图形介面，可以动态生成服务依赖关系图，即时显示服务间的网路流量、HTTP 请求、DNS 查询，甚至是 Network Policy 的阻挡情况。
- Hubble CLI ：一个命令列工具，让开发者和维运人员可以方便地从终端机中查询和过滤即时的网路流量事件
